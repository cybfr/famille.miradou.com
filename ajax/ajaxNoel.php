...
<a href="#draw" id="draw">Tirage 1016</a>
<a href="#drawLastYear" id="drawLastYear">Tirage 2015</a>
<a href="#drawLastLastYear" id="drawLastLastYear">Tirage 2014</a>
...
$('.mainFrameFooter').html(
		'<a href="#draw" id="draw">Tirage 2016</a>'+
		'<a href="#drawLastYear" id="drawLastYear">Tirage 2015</a>'+
		'<a href="#drawLastLastYear" id="drawLastLastYear">Tirage 2014</a>'+
		'<a href="#reset" id="reset" style="display: none">Remettre à zéro</a>'+
		'<a href="#text" id="opener" style="display: none">Afficher le texte</a>'+
